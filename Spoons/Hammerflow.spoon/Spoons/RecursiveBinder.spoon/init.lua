...
---             textFont='SF Mono'
---             textSize=20}
--- obj.helperFormat = {atScreenEdge=0,
---                    strokeColor={ white = 0, alpha = 2 },
---                    textFont='Courier',
---                    textSize=40,
---                    radius=0}
obj.helperFormat = {strokeWidth  = 2,
                    strokeColor = { red = 0.471, green = 0.663, blue = 1, alpha = 1 },
                    fillColor   = { red = 0.0863, green = 0.0863, blue = 0.0863, alpha = 1 },
                    textColor = { red = 0.471, green = 0.663, blue = 1, alpha = 1 },
                    textFont  = "MesloLGS NF",
                    textSize  = 14,
                    radius = 0,
                    atScreenEdge = 0,
                    fadeInDuration = 1,
